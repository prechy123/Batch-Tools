    ...
    <main className="h-screen container mx-6">
      <div className=" text-center mt-4 sm:mt-10">
        ...
        <p className=" text-lg sm:text-xl px-10 md:px-20 text-justify">
          ...
          these features into one convenient platform. At BatchTools, we believe
          in making digital tasks faster and more efficient. Our goal is to help
        ...
        >
          <button
            ...
            className="mb-2 inline-block rounded bg-[#128c7e] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg mr-2"
          >
        ...
        >
          <button
            ...
            data-twe-ripple-init
            data-twe-ripple-color="light"
            className="mb-2 inline-block rounded bg-[#ea4335] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg mr-2"
          >
            <span className="[&>svg]:h-4 [&>svg]:w-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
